...
public class Test1 extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            out.println("<a href='Test1'><button>Quay lại</button></a>");
            out.println("</div>");
            out.println("</body>");
            out.println("</html>");
        } catch (NumberFormatException e) {
            out.println("<html><body><h3 style='color:red;'>Vui lòng nhập đúng định dạng số!</h3><a href='Test1'>Quay lại</a></body></html>");
        }
	}
